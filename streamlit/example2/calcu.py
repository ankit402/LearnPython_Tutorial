...
def form_Cal():
    ...
    if col1.button('5'): st.session_state.total += '5'
    if col2.button('6'): st.session_state.total += '6'
    if col3.button('-'): st.session_state.total += '-'
    if col4.button('7'): st.session_state.total += '7'
    if col1.button('8'): st.session_state.total += '8'
    if col2.button('9'): st.session_state.total += '9'
    if col3.button('.'): st.session_state.total += '.'
